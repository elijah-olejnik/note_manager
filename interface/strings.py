from interface.localization import _
...
def update_strings():
    # Exception messages
    global missing_fields_str
    global data_fmt_err_str
    global empty_list_io_str
    global import_failed_str
    global note_with_id_str
